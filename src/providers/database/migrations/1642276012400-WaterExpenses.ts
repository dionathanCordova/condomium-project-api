...
export class WaterExpenses1642276012400 implements MigrationInterface {
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'add_value', type: 'float', isNullable: false },
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropTable('water-expenses');
  }
}
